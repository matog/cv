...
Con formación primaria como economista, y especializado en el procesamiento de información, he desarrollado actividades de consultoría tanto para el sector público como privado, desarrollando aplicaciones en [Python](https://www.python.org/) (utilizando frameworks como [Dash](https://plotly.com/dash/), [Streamlit](https://streamlit.io/) o [Flask](https://flask.palletsprojects.com/en/1.1.x/)), para la creación de dashboards, explotando diversas bases de datos y aplicando algoritmos de machine learning (regresiones, knn, clusters, nlp). En  [Github](https://github.com/matog/) se pueden ver algunos de mis proyectos.
...
[UBA Ingenieria](https://www.fi.uba.ar/noticias/curso-de-ciencia-de-datos-y-big-data), Buenos Aires _(Diciembre 2023)_
